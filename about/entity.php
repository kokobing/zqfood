...
<ul class="sub_nav">
				...
				<li><a href="/about/entity.php?pageid=6" class="cur_link">大旗岭猪场</a> </li>
				 
				<li><a href="/about/entity.php?pageid=7">加工厂</a> </li>
				 
		  </ul>
</div> <!--end about_cleft!-->
<div id="about_cright">
<div id="about_crightbanner"><img src="../inc/pics/aboutbanner.gif" /></div> 
<div id="about_crightnavi">您现在的位置：<a href="#" class="link_aboutnavi">首页</a> > <a href="#" class="link_aboutnavi">关于我们</a> > <a href="#" class="link_aboutnavi">两大实体</a></div> 
