...
where a.dele=1 and b.lang=1 order by a.id_newsinfo desc limit 6";
...
left join newsdir as b on a.id_newsdir=b.id_newsdir 
left join newspic as c on a.id_newsinfo=c.id_newsinfo 
where a.dele=1 and b.lang=1 and c.opicname!='' order by a.id_newsinfo desc limit 5";
$objDB->Execute($strSQL);
...
// 产品四大类
$strSQL ="select opicname,url,title from layoutpic  where id_layout='3' limit 4";
$objDB->Execute($strSQL);
...
<script type="text/javascript">
   ...
   auto: 3000,scroll: 1,speed: 600,visible: 4, vertical: true
    }); 
   });
</script>
...
stm_ai("p0i0",[0,"\r\n首 页","","",-1,-1,0,"/","_self","","","","",0,0,0,"","",0,0,0,1,1,"#FFFFFF",0,"#FFFFFF",0,"/inc/pics/menubg02.gif","/inc/pics/menubg02.gif",3,3,0,0,"#C8C8C8","#C8C8C8","#FFFFFF","#FFFFFF","bold 14px 'Arial','Verdana'","bold 14px 'Arial','Verdana'",0,0,"","","","",0,0,0],126,46);
stm_aix("p0i1","p0i0",[0,"\r\n公司简介","","",-1,-1,0,"/about/about.php","_self","","","","",0,0,0,"","",0,0,0,1,1,"#FFFFFF",0,"#FFFFFF",0,"/inc/pics/menubg01.gif","/inc/pics/menubg02.gif",3,3,0,0,"#C8C8C8","#C8C8C8","#59931A"],126,46);
stm_aix("p0i2","p0i1",[0,"\r\n两大实体","","",-1,-1,0,"/about/entity.php?pageid=6"],126,46);
stm_aix("p0i3","p0i1",[0,"\r\n产品中心","","",-1,-1,0,"/product/product.php"],126,46);
stm_aix("p0i4","p0i1",[0,"\r\n新闻中心","","",-1,-1,0,"/news/news.php"],126,46);
stm_aix("p0i5","p0i1",[0,"\r\n联系我们","","",-1,-1,0,"/about/about.php?pageid=5"],120,46);
stm_ep();
stm_em();
//-->
</script>
...
<div id="maincontent">
<div id="maincontent1">
<div id="maincontent1title"><img src="inc/pics/news.gif" /></div>
...
<div id="maincontent1title"><a href="/about/about.php?pageid=5"><img src="inc/pics/news2.gif" border="0" /></a></div>
</div><!--end maincontent1!-->
<div id="maincontent2">
<div id="maincontent2title">
<h1><a href="/news/newsinfo.php?newsid=<?=$news_sy[0][id_newsinfo];?>"><?=cutstr($news_sy[0][title],45,1);?></a></h1> 
...
<ul>
  <?php for($i=1;$i<sizeof($news_sy);$i++){?>
     <li><span>[<?=$news_sy[$i][newsdate];?>]</span><a href="/news/newsinfo.php?newsid=<?=$news_sy[$i][id_newsinfo];?>" class="link_navi"><?=cutstr($news_sy[$i][title],32,1);?></a></li>
  <?php }?>
</ul>
</div>
</div><!--end maincontent2news!-->
</div><!--end maincontent2!-->
<div id="maincontent3"><a href="/about/entity.php?pageid=6"><img src="inc/pics/hr.jpg" border="0" /></a></div>
<div id="maincontent4"><img src="inc/pics/hottel.jpg" border="0" usemap="#Map" />
<map name="Map" id="Map">
  <area shape="rect" coords="6,114,161,172" href="javascript:void(0)" onclick="needsendmail();" />
  <area shape="rect" coords="6,183,161,240" href="/product/product.php" />
</map></div>
