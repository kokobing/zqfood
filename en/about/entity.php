...
if(!isset($_GET[pageid])){$pageid='13';}else{$pageid=$_GET[pageid];}
//公司简介
...
<ul class="sub_nav">
				...
				<li><a href="/en/about/entity.php?pageid=13" class="cur_link">Daqiling Pig Farm</a> </li>
				 
				<li><a href="/en/about/entity.php?pageid=14">Workshop</a> </li>
				 
		  </ul>
</div> <!--end about_cleft!-->
<div id="about_cright">
<div id="about_crightbanner"><img src="/inc/pics/aboutbanner.gif" /></div> 
<div id="about_crightnavi">Now：<a href="/en/" class="link_aboutnavi">Home</a> > <a href="/en/about/entity.php?pageid=13" class="link_aboutnavi">Entities</a> > <?=$companyinfo[title];?></div> 
<div id="about_crighttitle">&nbsp;&nbsp;&nbsp;&nbsp;<?=$companyinfo[title];?></div>
<div id="entity_crightc"><?php echo $companyinfo[content];?></div>
